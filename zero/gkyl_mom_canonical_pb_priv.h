...
GKYL_CU_DH
static void
kernel_canonical_pb_int_mom_1x2v_ser_p1(const struct gkyl_mom_type *momt, const double *xc, const double *dx,
  const int *idx, const double *f, double* out, void *param)
{
  struct mom_type_canonical_pb *mom_can_pb = container_of(momt, struct mom_type_canonical_pb, momt);
  long pidx = gkyl_range_idx(&mom_can_pb->phase_range, idx);
...
GKYL_CU_DH
static void
kernel_canonical_pb_int_mom_1x2v_ser_p2(const struct gkyl_mom_type *momt, const double *xc, const double *dx,
  const int *idx, const double *f, double* out, void *param)
{
  struct mom_type_canonical_pb *mom_can_pb = container_of(momt, struct mom_type_canonical_pb, momt);
  long pidx = gkyl_range_idx(&mom_can_pb->phase_range, idx);
...
GKYL_CU_DH
static void
kernel_canonical_pb_int_mom_1x3v_ser_p1(const struct gkyl_mom_type *momt, const double *xc, const double *dx,
  const int *idx, const double *f, double* out, void *param)
{
  struct mom_type_canonical_pb *mom_can_pb = container_of(momt, struct mom_type_canonical_pb, momt);
  long pidx = gkyl_range_idx(&mom_can_pb->phase_range, idx);
...
GKYL_CU_DH
static void
kernel_canonical_pb_int_mom_1x3v_ser_p2(const struct gkyl_mom_type *momt, const double *xc, const double *dx,
  const int *idx, const double *f, double* out, void *param)
{
  struct mom_type_canonical_pb *mom_can_pb = container_of(momt, struct mom_type_canonical_pb, momt);
  long pidx = gkyl_range_idx(&mom_can_pb->phase_range, idx);
...
GKYL_CU_DH
static void
kernel_canonical_pb_int_mom_2x3v_ser_p1(const struct gkyl_mom_type *momt, const double *xc, const double *dx,
  const int *idx, const double *f, double* out, void *param)
{
  struct mom_type_canonical_pb *mom_can_pb = container_of(momt, struct mom_type_canonical_pb, momt);
  long pidx = gkyl_range_idx(&mom_can_pb->phase_range, idx);
...
GKYL_CU_DH
static void
kernel_canonical_pb_int_mom_2x3v_ser_p2(const struct gkyl_mom_type *momt, const double *xc, const double *dx,
  const int *idx, const double *f, double* out, void *param)
{
  struct mom_type_canonical_pb *mom_can_pb = container_of(momt, struct mom_type_canonical_pb, momt);
  long pidx = gkyl_range_idx(&mom_can_pb->phase_range, idx);
...
static const gkyl_canonical_pb_mom_kern_list ser_int_mom_kernels[] = {
  ...
  { NULL, kernel_canonical_pb_int_mom_1x2v_ser_p1, kernel_canonical_pb_int_mom_1x2v_ser_p2 }, // 1
  { NULL, kernel_canonical_pb_int_mom_1x3v_ser_p1, kernel_canonical_pb_int_mom_1x3v_ser_p2 }, // 2
  // 2x kernels
...
GKYL_CU_DH
static void
kernel_canonical_pb_int_mom_1x1v_tensor_p1(const struct gkyl_mom_type *momt, const double *xc, const double *dx,
  const int *idx, const double *f, double* out, void *param)
{
  struct mom_type_canonical_pb *mom_can_pb = container_of(momt, struct mom_type_canonical_pb, momt);
  long pidx = gkyl_range_idx(&mom_can_pb->phase_range, idx);
...
GKYL_CU_DH
static void
kernel_canonical_pb_int_mom_1x1v_tensor_p2(const struct gkyl_mom_type *momt, const double *xc, const double *dx,
  const int *idx, const double *f, double* out, void *param)
{
  struct mom_type_canonical_pb *mom_can_pb = container_of(momt, struct mom_type_canonical_pb, momt);
  long pidx = gkyl_range_idx(&mom_can_pb->phase_range, idx);
...
GKYL_CU_DH
static void
kernel_canonical_pb_int_mom_1x2v_tensor_p1(const struct gkyl_mom_type *momt, const double *xc, const double *dx,
  const int *idx, const double *f, double* out, void *param)
{
  struct mom_type_canonical_pb *mom_can_pb = container_of(momt, struct mom_type_canonical_pb, momt);
  long pidx = gkyl_range_idx(&mom_can_pb->phase_range, idx);
...
GKYL_CU_DH
static void
kernel_canonical_pb_int_mom_1x2v_tensor_p2(const struct gkyl_mom_type *momt, const double *xc, const double *dx,
  const int *idx, const double *f, double* out, void *param)
{
  struct mom_type_canonical_pb *mom_can_pb = container_of(momt, struct mom_type_canonical_pb, momt);
  long pidx = gkyl_range_idx(&mom_can_pb->phase_range, idx);
...
GKYL_CU_DH
static void
kernel_canonical_pb_int_mom_1x3v_tensor_p1(const struct gkyl_mom_type *momt, const double *xc, const double *dx,
  const int *idx, const double *f, double* out, void *param)
{
  struct mom_type_canonical_pb *mom_can_pb = container_of(momt, struct mom_type_canonical_pb, momt);
  long pidx = gkyl_range_idx(&mom_can_pb->phase_range, idx);
...
GKYL_CU_DH
static void
kernel_canonical_pb_int_mom_1x3v_tensor_p2(const struct gkyl_mom_type *momt, const double *xc, const double *dx,
  const int *idx, const double *f, double* out, void *param)
{
  struct mom_type_canonical_pb *mom_can_pb = container_of(momt, struct mom_type_canonical_pb, momt);
  long pidx = gkyl_range_idx(&mom_can_pb->phase_range, idx);
...
GKYL_CU_DH
static void
kernel_canonical_pb_int_mom_2x2v_tensor_p1(const struct gkyl_mom_type *momt, const double *xc, const double *dx,
  const int *idx, const double *f, double* out, void *param)
{
  struct mom_type_canonical_pb *mom_can_pb = container_of(momt, struct mom_type_canonical_pb, momt);
  long pidx = gkyl_range_idx(&mom_can_pb->phase_range, idx);
...
GKYL_CU_DH
static void
kernel_canonical_pb_int_mom_2x2v_tensor_p2(const struct gkyl_mom_type *momt, const double *xc, const double *dx,
  const int *idx, const double *f, double* out, void *param)
{
  struct mom_type_canonical_pb *mom_can_pb = container_of(momt, struct mom_type_canonical_pb, momt);
  long pidx = gkyl_range_idx(&mom_can_pb->phase_range, idx);
...
GKYL_CU_DH
static void
kernel_canonical_pb_int_mom_2x3v_tensor_p1(const struct gkyl_mom_type *momt, const double *xc, const double *dx,
  const int *idx, const double *f, double* out, void *param)
{
  struct mom_type_canonical_pb *mom_can_pb = container_of(momt, struct mom_type_canonical_pb, momt);
  long pidx = gkyl_range_idx(&mom_can_pb->phase_range, idx);
...
GKYL_CU_DH
static void
kernel_canonical_pb_int_mom_3x3v_tensor_p1(const struct gkyl_mom_type *momt, const double *xc, const double *dx,
  const int *idx, const double *f, double* out, void *param)
{
  struct mom_type_canonical_pb *mom_can_pb = container_of(momt, struct mom_type_canonical_pb, momt);
  long pidx = gkyl_range_idx(&mom_can_pb->phase_range, idx);
...
// Integrated moment kernel list
GKYL_CU_D
static const gkyl_canonical_pb_mom_kern_list tensor_int_mom_kernels[] = {
  // 1x kernels
  { NULL, kernel_canonical_pb_int_mom_1x1v_tensor_p1, kernel_canonical_pb_int_mom_1x1v_tensor_p2 }, // 0
  { NULL, kernel_canonical_pb_int_mom_1x2v_tensor_p1, kernel_canonical_pb_int_mom_1x2v_tensor_p2 }, // 1
  { NULL, kernel_canonical_pb_int_mom_1x3v_tensor_p1, kernel_canonical_pb_int_mom_1x3v_tensor_p2 }, // 2
  // 2x kernels
  { NULL, kernel_canonical_pb_int_mom_2x2v_tensor_p1, kernel_canonical_pb_int_mom_2x2v_tensor_p2 }, // 3
  { NULL, kernel_canonical_pb_int_mom_2x3v_tensor_p1, NULL }, // 4
  // 3x kernels
  { NULL, kernel_canonical_pb_int_mom_3x3v_tensor_p1, NULL                                 }, // 5
};
